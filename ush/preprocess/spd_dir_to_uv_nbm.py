...
with nc.Dataset(flout, 'w', format='NETCDF4') as ncout:
    # Create dimensions
    ncout.createDimension('X' , nx)  # Unlimited dimension
    ncout.createDimension('Y' , ny)
    ncout.createDimension('time', nt)
    
    lon_var=ncout.createVariable('longitude', 'f8', ('X',))
    ...
    lat_var=ncout.createVariable('latitude', 'f8', ('Y',))
    ...
    u_var=ncout.createVariable('UGRD_10maboveground', 'f4', ('time','Y','X'), fill_value = fill_value0)
    ...
    v_var=ncout.createVariable('VGRD_10maboveground', 'f4', ('time','Y','X'), fill_value = fill_value0)
