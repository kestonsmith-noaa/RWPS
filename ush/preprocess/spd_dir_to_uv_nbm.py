...
with nc.Dataset(flout, 'w', format='NETCDF4') as ncout:
    ...
    u_var=ncout.createVariable('UGRD_10maboveground', 'f4', ('T','Y','X'),fill_value    = fill_value0)
    ...
    v_var=ncout.createVariable('VGRD_10maboveground', 'f4', ('T','Y','X'),fill_value    = fill_value0)
